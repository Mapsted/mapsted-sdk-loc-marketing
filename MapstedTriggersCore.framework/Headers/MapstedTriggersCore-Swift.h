...
#ifndef MAPSTEDTRIGGERSCORE_SWIFT_H
#define MAPSTEDTRIGGERSCORE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MapstedTriggersCore",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC19MapstedTriggersCore9HTMLLabel")
...
SWIFT_CLASS("_TtC19MapstedTriggersCore25InAppNotifyViewController")
...
SWIFT_CLASS("_TtC19MapstedTriggersCore22MapstedTriggersManager")
@interface MapstedTriggersManager : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC19MapstedTriggersCore27MarketingPageViewController")
@interface MarketingPageViewController : UIPageViewController
- (void)viewDidLoad;
...
@interface MarketingPageViewController (SWIFT_EXTENSION(MapstedTriggersCore))
- (void)closeBanner;
@end


@interface MarketingPageViewController (SWIFT_EXTENSION(MapstedTriggersCore)) <UIPageViewControllerDataSource, UIPageViewControllerDelegate>
