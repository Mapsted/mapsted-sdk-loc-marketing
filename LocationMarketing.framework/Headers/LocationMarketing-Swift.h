...
#ifndef LOCATIONMARKETING_SWIFT_H
#define LOCATIONMARKETING_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="LocationMarketing",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17LocationMarketing19LocMarketingManager")
@interface LocMarketingManager : MapstedTriggersManager
